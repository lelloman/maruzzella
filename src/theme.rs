...
impl Default for ThemePalette {
    fn default() -> Self {
        Self {
            bg_0: "#1f2124".to_string(),
            bg_1: "#2a2d31".to_string(),
            workbench: "#1e1f22".to_string(),
            panel_left: "#2b2d30".to_string(),
            panel_right: "#2b2d30".to_string(),
            panel_bottom: "#17181c".to_string(),
            border: "#34383e".to_string(),
            border_strong: "#4d5360".to_string(),
            text_0: "#d3d8df".to_string(),
            text_1: "#adb4bf".to_string(),
            text_2: "#727a86".to_string(),
            accent: "#4b78c2".to_string(),
            accent_strong: "#5d9bff".to_string(),
        }
    }
}
...
impl Default for ThemeTypography {
    fn default() -> Self {
        Self {
            font_family: "\"JetBrains Sans\", \"Noto Sans\", \"Cantarell\", sans-serif".to_string(),
            mono_font_family: "\"JetBrains Mono\", \"Iosevka Fixed\", monospace".to_string(),
            font_size_base: 14,
            font_size_ui: 13,
            font_size_small: 12,
            font_size_tiny: 10,
...
impl Default for ThemeDensity {
    fn default() -> Self {
        Self {
            ...
            min_side_panel_width: 220,
            min_bottom_panel_height: 140,
            radius_none: 0,
            radius_small: 4,
            radius_medium: 8,
            radius_large: 10,
            ...
            tab_height: 28,
            icon_size: 16,
            search_width_min: 260,
            search_width_max: 340,
            command_width_min: 160,
            panel_header_height: 16,
        }
    }
}
...
fn default_component_tokens() -> BTreeMap<String, String> {
    BTreeMap::from([
        ("color_app_shell".to_string(), "#1e1f22".to_string()),
        ("color_topbar".to_string(), "#2a2c2f".to_string()),
        ("color_topbar_border".to_string(), "#31343a".to_string()),
        ("topbar_border".to_string(), "1px solid #31343a".to_string()),
        ("color_window_strip_border".to_string(), "#303339".to_string()),
        ("window_strip_border".to_string(), "1px solid #303339".to_string()),
        ("color_window_meta".to_string(), "#99a2af".to_string()),
        ("color_window_title".to_string(), "#c9ced6".to_string()),
        ("color_window_branch_bg".to_string(), "#303338".to_string()),
        ("space_window_strip_inline".to_string(), "6px".to_string()),
        ("window_strip_height".to_string(), "23px".to_string()),
        ("window_branch_padding".to_string(), "0 4px".to_string()),
        ("window_controls_spacing".to_string(), "2px".to_string()),
        ("menu_bar_height".to_string(), "18px".to_string()),
        ("space_menu_inline".to_string(), "4px".to_string()),
        ("color_menu_bg".to_string(), "#23252a".to_string()),
        ("color_menu_text".to_string(), "#9ea6b2".to_string()),
        ("color_menu_hover".to_string(), "#343943".to_string()),
        ("space_menu_button_inline".to_string(), "9px".to_string()),
        ("color_toolbar_bg".to_string(), "#26292e".to_string()),
        ("toolbar_bottom_border".to_string(), "1px solid @border".to_string()),
        ("color_toolbar_group".to_string(), "#2d3137".to_string()),
        ("color_toolbar_group_border".to_string(), "#353a42".to_string()),
        ("toolbar_group_border".to_string(), "1px solid #353a42".to_string()),
        ("space_toolbar_group".to_string(), "3px".to_string()),
        ("space_toolbar_group_primary".to_string(), "10px".to_string()),
        ("color_toolbar_group_subtle".to_string(), "#2b2f35".to_string()),
        ("color_toolbar_title_chip".to_string(), "#22252a".to_string()),
        ("color_toolbar_title".to_string(), "#c9d0d8".to_string()),
        ("color_toolbar_meta".to_string(), "#8b93a0".to_string()),
        ("toolbar_title_tracking".to_string(), "0.01em".to_string()),
        ("padding_toolbar_status_cluster".to_string(), "0 2px 0 8px".to_string()),
        ("control_height_button".to_string(), "26px".to_string()),
        ("space_button_inline".to_string(), "14px".to_string()),
        ("color_button_text".to_string(), "#b5bcc7".to_string()),
        ("color_button_hover".to_string(), "#2a2e33".to_string()),
        ("color_button_active".to_string(), "#2b2f34".to_string()),
        ("context_chip_icon_opacity".to_string(), "0.62".to_string()),
        ("color_muted_action_text".to_string(), "#a8afba".to_string()),
        ("color_muted_action_hover".to_string(), "#2f3338".to_string()),
        ("color_muted_action_active".to_string(), "#292d31".to_string()),
        ("space_project_chip_inline".to_string(), "10px".to_string()),
        ("flat_chip_height".to_string(), "22px".to_string()),
        ("flat_chip_padding".to_string(), "0 10px".to_string()),
        ("flat_control_height".to_string(), "24px".to_string()),
        ("flat_control_padding".to_string(), "0 12px".to_string()),
        ("color_accent_action_bg".to_string(), "#383d45".to_string()),
        ("color_accent_action_text".to_string(), "#d8dee8".to_string()),
        ("color_accent_action_hover".to_string(), "#434952".to_string()),
        ("nav_rail_width".to_string(), "24px".to_string()),
        ("nav_rail_padding".to_string(), "6px 0".to_string()),
        ("color_nav_rail_bg".to_string(), "#272a2f".to_string()),
        ("space_nav_rail_group".to_string(), "4px".to_string()),
        ("color_nav_separator".to_string(), "#32363d".to_string()),
        ("hairline_size".to_string(), "1px".to_string()),
        ("nav_separator_margin".to_string(), "3px 0".to_string()),
        ("nav_button_width".to_string(), "28px".to_string()),
        ("nav_button_height".to_string(), "28px".to_string()),
        ("nav_button_padding".to_string(), "3px".to_string()),
        ("color_nav_button_text".to_string(), "#7f8895".to_string()),
        ("space_entry_inline".to_string(), "10px".to_string()),
        ("color_entry_bg".to_string(), "#26292e".to_string()),
        ("color_search_bg".to_string(), "#202328".to_string()),
        ("color_search_border".to_string(), "#353a42".to_string()),
        ("search_border".to_string(), "1px solid #353a42".to_string()),
        ("space_search_inline".to_string(), "14px".to_string()),
        ("color_search_focus_border".to_string(), "#486a9e".to_string()),
        ("search_focus_border".to_string(), "1px solid #486a9e".to_string()),
        ("color_search_focus_bg".to_string(), "#24282e".to_string()),
        ("icon_button_width".to_string(), "30px".to_string()),
        ("icon_button_height".to_string(), "30px".to_string()),
        ("icon_button_padding".to_string(), "4px 7px".to_string()),
        ("icon_button_border".to_string(), "1px solid transparent".to_string()),
        ("color_icon_button_hover".to_string(), "#383d45".to_string()),
        ("color_icon_button_hover_border".to_string(), "#444a54".to_string()),
        ("space_utility_group".to_string(), "4px".to_string()),
        ("color_selection_bg".to_string(), "#345278".to_string()),
        ("color_selection_text".to_string(), "#f4f8fe".to_string()),
        ("color_separator_fill".to_string(), "#3b4048".to_string()),
        ("separator_alpha".to_string(), "0.22".to_string()),
        ("separator_size".to_string(), "8px".to_string()),
        ("drop_zone_width".to_string(), "28px".to_string()),
        ("drop_zone_height".to_string(), "28px".to_string()),
        ("drop_zone_side_width".to_string(), "40px".to_string()),
        ("drop_zone_bottom_height".to_string(), "40px".to_string()),
        ("color_drop_zone_fill".to_string(), "#5d95df".to_string()),
        ("drop_zone_fill_alpha".to_string(), "0.24".to_string()),
        ("color_drop_zone_border".to_string(), "#80adf0".to_string()),
        ("drop_zone_border_alpha".to_string(), "0.36".to_string()),
        ("drop_zone_border".to_string(), "1px solid alpha(#80adf0, 0.36)".to_string()),
        ("notebook_tab_padding".to_string(), "0 11px 1px 11px".to_string()),
        ("notebook_tab_border_width".to_string(), "2px".to_string()),
        ("color_notebook_tab_bg".to_string(), "#24272c".to_string()),
        ("color_notebook_tab_text".to_string(), "#7f8794".to_string()),
        ("color_notebook_tab_hover".to_string(), "#31353a".to_string()),
        ("color_notebook_tab_hover_border".to_string(), "#5f6670".to_string()),
        ("color_notebook_tab_hover_text".to_string(), "#b7bec9".to_string()),
        ("color_notebook_tab_active".to_string(), "#2c3036".to_string()),
        ("notebook_tab_active_border_width".to_string(), "3px".to_string()),
        ("color_notebook_tab_active_border".to_string(), "#7a8089".to_string()),
        ("color_notebook_tab_drop_border".to_string(), "#6b727c".to_string()),
        ("notebook_tab_drop_shadow".to_string(), "inset 0 -2px #6b727c".to_string()),
        ("color_editor_tab_bg".to_string(), "#2b2e33".to_string()),
        ("color_editor_tab_active".to_string(), "#30343a".to_string()),
        ("tool_tab_height".to_string(), "23px".to_string()),
        ("space_tab_header".to_string(), "5px".to_string()),
        ("tab_close_width".to_string(), "18px".to_string()),
        ("tab_close_height".to_string(), "18px".to_string()),
        ("tab_close_padding".to_string(), "2px".to_string()),
        ("color_tab_close_text".to_string(), "#808896".to_string()),
        ("color_tab_close_hover".to_string(), "#404650".to_string()),
        ...
        ("preview_top_border".to_string(), "1px solid alpha(#8b96a8, 0.18)".to_string()),
        ("color_preview_header_bg".to_string(), "#1c1f25".to_string()),
        ("color_tab_strip_scroller_bg".to_string(), "#202329".to_string()),
        ("tab_strip_border_alpha".to_string(), "0.14".to_string()),
        ("tab_strip_scroller_border".to_string(), "1px solid alpha(#8b96a8, 0.14)".to_string()),
        ("tab_strip_height".to_string(), "31px".to_string()),
        ("color_workbench_tab_bg".to_string(), "#26292f".to_string()),
        ("color_workbench_tab_text".to_string(), "#9098a5".to_string()),
        ("color_workbench_tab_hover".to_string(), "#2f343b".to_string()),
        ("color_workbench_tab_hover_text".to_string(), "#c5ccd6".to_string()),
        ("color_workbench_tab_active".to_string(), "#30343a".to_string()),
        ("workbench_tab_padding".to_string(), "0 12px 1px 12px".to_string()),
        ("workbench_tab_border_width".to_string(), "2px".to_string()),
        ("color_drag_preview_bg".to_string(), "#353a42".to_string()),
        ("color_drag_preview_border".to_string(), "#8a9099".to_string()),
        ("drag_preview_shadow".to_string(), "0 10px 22px alpha(black, 0.28)".to_string()),
        ("drag_preview_opacity".to_string(), "0.96".to_string()),
        ("tab_drag_gap_width".to_string(), "48px".to_string()),
        ("tab_drag_gap_height".to_string(), "28px".to_string()),
        ("tab_drag_gap_border".to_string(), "2px dashed alpha(#8ea4c5, 0.55)".to_string()),
        ("tab_drag_gap_bg".to_string(), "alpha(#8ea4c5, 0.12)".to_string()),
        ("workbench_split_margin".to_string(), "6px".to_string()),
        ("workbench_split_fill".to_string(), "alpha(#6d88af, 0.22)".to_string()),
        ("workbench_split_border".to_string(), "1px solid alpha(#8ea4c5, 0.42)".to_string()),
        ("split_preview_side_width".to_string(), "80px".to_string()),
        ("split_preview_bottom_height".to_string(), "72px".to_string()),
        ("panel_title_tracking".to_string(), "0.04em".to_string()),
        ("panel_title_color".to_string(), "#8f97a3".to_string()),
        ("section_title_tracking".to_string(), "0.08em".to_string()),
        ("panel_content_padding".to_string(), "8px".to_string()),
        ("dense_row_height".to_string(), "20px".to_string()),
        ("dense_row_selected_bg".to_string(), "#373f49".to_string()),
        ("dense_row_selected_text".to_string(), "#f2f6fc".to_string()),
        ("dense_row_hover_bg".to_string(), "alpha(#40464f, 0.28)".to_string()),
        ("list_row_padding".to_string(), "6px 10px".to_string()),
        ("inspector_value_color".to_string(), "#d9e4f6".to_string()),
        ("status_badge_padding".to_string(), "2px 6px".to_string()),
        ("color_status_badge_bg".to_string(), "#3a404d".to_string()),
        ("color_status_badge_text".to_string(), "#dbe5f2".to_string()),
        ...
        ("color_tool_window_surface".to_string(), "#2d3033".to_string()),
        ("color_scrollbar_trough".to_string(), "#25282d".to_string()),
        ("scrollbar_slider_size".to_string(), "6px".to_string()),
        ("color_scrollbar_slider".to_string(), "#4a5059".to_string()),
        ("color_scrollbar_slider_hover".to_string(), "#59616d".to_string()),
        ("status_bar_height".to_string(), "14px".to_string()),
        ("color_status_bar_bg".to_string(), "#26292e".to_string()),
        ("color_status_item".to_string(), "#9fa7b3".to_string()),
...
mod tests {
    ...
    fn renders_builtin_template_with_default_tokens() {
        ...
        assert!(stylesheet.contains("@define-color bg_0 #1f2124;"));
        assert!(stylesheet.contains("font-size: 14px;"));
