...
fn default_component_tokens() -> BTreeMap<String, String> {
    BTreeMap::from([
        ("color_app_shell".to_string(), "#16181d".to_string()),
        ...
        ("window_strip_height".to_string(), "44px".to_string()),
        ("window_branch_padding".to_string(), "0 10px".to_string()),
        ("window_controls_spacing".to_string(), "8px".to_string()),
        ("menu_bar_height".to_string(), "32px".to_string()),
        ("space_menu_inline".to_string(), "6px".to_string()),
        ("color_menu_bg".to_string(), "transparent".to_string()),
        ("color_menu_text".to_string(), "#93a0b2".to_string()),
        ...
        ("button_radius".to_string(), "3px".to_string()),
        ("color_button_text".to_string(), "#c2ccd8".to_string()),
        ("color_button_hover".to_string(), "#252c36".to_string()),
        ...
        ("color_nav_separator".to_string(), "#2a3039".to_string()),
        ...
        ("color_nav_button_text".to_string(), "#8692a3".to_string()),
        ("space_entry_inline".to_string(), "14px".to_string()),
        ("color_entry_bg".to_string(), "#20242b".to_string()),
        ("search_radius".to_string(), "8px".to_string()),
        ("color_search_bg".to_string(), "#20242b".to_string()),
        ...
        ("color_separator_fill".to_string(), "#46505d".to_string()),
        ("separator_alpha".to_string(), "0.18".to_string()),
        ("separator_size".to_string(), "10px".to_string()),
        ...
        ("color_drop_zone_fill".to_string(), "#6aa4ff".to_string()),
        ...
        ("tab_radius".to_string(), "6px".to_string()),
        ...
        ("color_tab_close_text".to_string(), "#8d98a7".to_string()),
        ("color_tab_close_hover".to_string(), "#343d49".to_string()),
        ...
        ("color_status_badge_bg".to_string(), "#2d3440".to_string()),
