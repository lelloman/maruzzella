...
impl ThemeSpec {
    fn token_map(&self) -> BTreeMap<String, String> {
        ...
        tokens.extend(default_component_tokens(self));
...
fn default_component_tokens(spec: &ThemeSpec) -> BTreeMap<String, String> {
    ...
    BTreeMap::from([
        ("color_app_shell".to_string(), p.bg_0.clone()),
        ("color_topbar".to_string(), p.panel_right.clone()),
        ("color_topbar_border".to_string(), p.border.clone()),
        (
            "topbar_border".to_string(),
            format!("1px solid {}", p.border),
        ),
        ("color_window_strip_border".to_string(), p.border.clone()),
        (
            "window_strip_border".to_string(),
            format!("1px solid {}", p.border),
        ),
        ("color_window_meta".to_string(), p.text_2.clone()),
        ("color_window_title".to_string(), p.text_0.clone()),
        ("color_window_branch_bg".to_string(), p.bg_1.clone()),
        ("space_window_strip_inline".to_string(), "0px".to_string()),
        ("window_strip_height".to_string(), "28px".to_string()),
        ...
        ("color_menu_bg".to_string(), p.panel_right.clone()),
        ("color_menu_text".to_string(), p.text_1.clone()),
        ("color_menu_hover".to_string(), hover.to_string()),
        ("space_menu_button_inline".to_string(), "8px".to_string()),
        ("color_toolbar_bg".to_string(), p.panel_left.clone()),
        (
            "toolbar_bottom_border".to_string(),
            format!("1px solid {}", p.border),
        ),
        ("color_toolbar_group".to_string(), "transparent".to_string()),
        ("color_toolbar_group_border".to_string(), p.border.clone()),
        (
        ...
        ("color_toolbar_title_chip".to_string(), p.bg_1.clone()),
        ("color_toolbar_title".to_string(), p.text_0.clone()),
        ("color_toolbar_meta".to_string(), p.text_2.clone()),
        ("toolbar_title_tracking".to_string(), "0".to_string()),
        (
            "padding_toolbar_status_cluster".to_string(),
            "0".to_string(),
        ),
        ("control_height_button".to_string(), "28px".to_string()),
        ("space_button_inline".to_string(), "8px".to_string()),
        ("button_radius".to_string(), "2px".to_string()),
        ("color_button_text".to_string(), p.text_1.clone()),
        ("color_button_hover".to_string(), hover.to_string()),
        ("color_button_active".to_string(), hover_strong.to_string()),
        ("context_chip_icon_opacity".to_string(), "0.78".to_string()),
        ("color_muted_action_text".to_string(), p.text_1.clone()),
        ("color_muted_action_hover".to_string(), hover.to_string()),
        (
            "color_muted_action_active".to_string(),
            hover_strong.to_string(),
        ),
        ...
        ("flat_control_height".to_string(), "28px".to_string()),
        ("flat_control_padding".to_string(), "0 10px".to_string()),
        ("color_accent_action_bg".to_string(), p.accent.clone()),
        (
        ...
        ("color_nav_separator".to_string(), p.border.clone()),
        ("hairline_size".to_string(), "1px".to_string()),
        ("nav_separator_margin".to_string(), "8px 0".to_string()),
        ("nav_button_width".to_string(), "40px".to_string()),
        ("nav_button_height".to_string(), "40px".to_string()),
        ("nav_button_padding".to_string(), "6px".to_string()),
        ("color_nav_button_text".to_string(), p.text_2.clone()),
        ("space_entry_inline".to_string(), "8px".to_string()),
        ("color_entry_bg".to_string(), p.bg_0.clone()),
        ("search_radius".to_string(), "2px".to_string()),
        ("color_search_bg".to_string(), p.bg_0.clone()),
        ("color_search_border".to_string(), p.border.clone()),
        (
            "search_border".to_string(),
            format!("1px solid {}", p.border),
        ),
        ("space_search_inline".to_string(), "8px".to_string()),
        ("color_search_focus_border".to_string(), p.accent.clone()),
        (
            "search_focus_border".to_string(),
            format!("1px solid {}", p.accent),
        ),
        ("color_search_focus_bg".to_string(), p.bg_0.clone()),
        ("icon_button_width".to_string(), "28px".to_string()),
        ("icon_button_height".to_string(), "28px".to_string()),
        ("icon_button_padding".to_string(), "2px".to_string()),
        (
            "icon_button_border".to_string(),
            "1px solid transparent".to_string(),
        ),
        ("color_icon_button_hover".to_string(), hover.to_string()),
        (
            "color_icon_button_hover_border".to_string(),
            p.border.clone(),
        ),
        ("space_utility_group".to_string(), "6px".to_string()),
        ("color_selection_bg".to_string(), p.accent.clone()),
        (
            "color_selection_text".to_string(),
            selected_text.to_string(),
        ),
        ...
        ("color_drop_zone_fill".to_string(), p.accent.clone()),
        ("drop_zone_fill_alpha".to_string(), "0.18".to_string()),
        ("color_drop_zone_border".to_string(), p.accent.clone()),
        ("drop_zone_border_alpha".to_string(), "0.48".to_string()),
        (
            "drop_zone_border".to_string(),
            format!("1px solid alpha({}, 0.48)", p.accent),
        ),
        ("tab_radius".to_string(), "0".to_string()),
        ("notebook_tab_padding".to_string(), "0 10px".to_string()),
        ("notebook_tab_border_width".to_string(), "1px".to_string()),
        (
            "color_notebook_tab_bg".to_string(),
            "transparent".to_string(),
        ),
        ("color_notebook_tab_text".to_string(), p.text_2.clone()),
        ("color_notebook_tab_hover".to_string(), hover.to_string()),
        (
        ...
        ("color_tab_close_text".to_string(), p.text_2.clone()),
        (
            "color_tab_close_hover".to_string(),
            hover_strong.to_string(),
        ),
        ("color_preview_bg".to_string(), p.workbench.clone()),
        ("color_preview_border".to_string(), p.border.clone()),
        ("preview_border_alpha".to_string(), "0.18".to_string()),
        (
            "preview_top_border".to_string(),
            format!("1px solid alpha({}, 0.40)", p.border),
        ),
        ("color_preview_header_bg".to_string(), p.bg_1.clone()),
        ("color_tab_strip_scroller_bg".to_string(), p.bg_1.clone()),
        ("tab_strip_border_alpha".to_string(), "1.0".to_string()),
        (
        ...
        ("color_workbench_tab_text".to_string(), p.text_2.clone()),
        ("color_workbench_tab_hover".to_string(), hover.to_string()),
        (
        ...
        ("color_drag_preview_bg".to_string(), p.panel_right.clone()),
        ("color_drag_preview_border".to_string(), p.border.clone()),
        ("drag_preview_shadow".to_string(), "none".to_string()),
        ...
        ("panel_title_tracking".to_string(), "0.02em".to_string()),
        ...
        (
            "color_status_badge_bg".to_string(),
            hover_strong.to_string(),
        ),
        ("color_status_badge_text".to_string(), p.text_0.clone()),
        ("color_status_idle_bg".to_string(), p.bg_1.clone()),
        ("color_status_idle_text".to_string(), p.text_1.clone()),
        ("color_status_loaded_bg".to_string(), "#332a16".to_string()),
        ("color_status_loaded_text".to_string(), warning.to_string()),
        ("color_status_running_bg".to_string(), "#183025".to_string()),
        ("color_status_running_text".to_string(), success.to_string()),
        ("color_textview_text".to_string(), p.text_1.clone()),
        (
        ...
        (
            ...
            format!("alpha({}, 0.42)", p.border_strong),
        ),
        (
        ...
        (
            ...
            format!("1px solid alpha({}, 0.65)", p.border),
        ),
        ("plugin_list_row_padding".to_string(), "4px 8px".to_string()),
        (
        ...
        ("color_plugin_hero_bg".to_string(), p.bg_1.clone()),
        ("plugin_hero_padding".to_string(), "8px".to_string()),
        ("color_plugin_name".to_string(), p.text_0.clone()),
        ("color_plugin_description".to_string(), p.text_1.clone()),
        ("color_plugin_overview".to_string(), p.text_2.clone()),
        (
            "plugin_footer_padding".to_string(),
            "8px 4px 4px 0".to_string(),
        ),
        ("color_popover_bg".to_string(), p.panel_right.clone()),
        (
        ...
        ("popover_button_padding".to_string(), "3px 10px".to_string()),
        ("color_popover_button_text".to_string(), p.text_1.clone()),
        ("color_popover_button_hover".to_string(), p.accent.clone()),
        (
        ...
        ("color_popover_separator".to_string(), p.border.clone()),
...
fn tone_color(palette: &ThemePalette, tone: Tone) -> String {
    match tone {
        ...
        Tone::Success => "#83d0ae".to_string(),
        Tone::Warning => "#ffc66d".to_string(),
        Tone::Danger => "#ffb4ab".to_string(),
    }
}
